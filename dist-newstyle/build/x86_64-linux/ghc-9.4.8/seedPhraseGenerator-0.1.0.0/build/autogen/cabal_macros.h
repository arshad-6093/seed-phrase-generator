...
/* package seedPhraseGenerator-0.1.0.0 */
#ifndef VERSION_seedPhraseGenerator
#define VERSION_seedPhraseGenerator "0.1.0.0"
#endif /* VERSION_seedPhraseGenerator */
#ifndef MIN_VERSION_seedPhraseGenerator
#define MIN_VERSION_seedPhraseGenerator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_seedPhraseGenerator */
...
#define CURRENT_PACKAGE_KEY "seedPhraseGenerator-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "seedPhraseGenerator-0.1.0.0-inplace"
